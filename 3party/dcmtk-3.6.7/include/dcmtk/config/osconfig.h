...
#define DCMTK_PREFIX "E:\\work\\dcmtk\\build\\INSTALL"
...
#define DEFAULT_CONFIGURATION_DIR "%PROGRAMDATA%\\dcmtk-3.6.7-DEV\\etc\\"

/* Define to the default support data directory (used by some applications) */
#define DEFAULT_SUPPORT_DATA_DIR "%PROGRAMDATA%\\dcmtk-3.6.7-DEV\\share\\"
...
#define PACKAGE_VERSION_NUMBER 367
